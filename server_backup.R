...
connect=odbcConnect("MyAppDB", uid='root', pwd='16souemna')
...
shinyServer(function(input, output,session) {
                 ...
                 div(
                   ...
                   fluidRow(
                     box(width = 12,height = 300, status = "info",solidHeader = TRUE,
                         ...
                         column("",textInput("quantity","Quantity",""),width = 6),
  ...
  observeEvent( input$subb, {
    ...
    validate(
      need(input$idPattt!="PPPLL****"  , "Error : Missing values or User already exists")
    )
    validate(
      need(input$idPattt!=""  , "Error : Missing values or User already exists")
    )
    validate(
      need(try( sqlExecute(connect,query = queryIpfe)  ), "Error : Missing values or User already exists")
    )
    ...
    validate(
      need(try(    sqlExecute(connect,query = querytravinpfe)), "Error : Missing values or User already exists")
    )
    ...
    output$AdddRegion=renderUI({
      ...
      div(
        ...
        box(width = 12, status = "info",solidHeader = TRUE,
            ...
            column("",dateInput("datedatevisit","Visit Date",value = data.frame(sqlQuery(connect,sprintf("SELECT 	BIRTH_DATE from dbpfedev.patient where PATIENT_IDENTIFIER='%s'",as.character(input$PatIdentifier))))$BIRTH_DATE), width = 4) ,
            column("",numericInput("dateleavevisit","Duration (In week)",""), width = 4)
    ...
    output$AdddTreatment=renderUI({
      ...
      div(
        ...
        box(width = 12, status = "info",solidHeader = TRUE,
            ...
            column("",numericInput("datetreatend","Treatment Duration (in weeks)",""), width = 4),
    ...
    output$Adddcheckup=renderUI({
      ...
      div(
        ...
        box(width = 12, status = "info",solidHeader = TRUE,
            ...
            column("",selectizeInput("HhostR","Surrounding human cases", c("","Family","Neighbour","Colleague","No","N/A"), multiple = TRUE), width = 4),
            ...
            column("",selectizeInput("Ahost","Possible animal contact", c("",  "Bovines","Ovins","Caprins","Camels","Equids","Hares","Cats","Dogs","Foxs","Other Canids","Sandrats","Meriones","Other rodents","Gondis","Hedgehogs","Bates","Hyrax","No","N/A"), multiple = TRUE), width = 4),
  ...
  observeEvent(input$othercheckAdd, {
    ...
    validate(
      need(input$Lesion_Number>= -1, "Error : Missing values or User already exists")
    )
    ...
    validate(
      need(try(  sqlExecute(connect,query = querycheckinpfe)  ), "Error : Missing values or User already exists")
    )
    #
  ...
  observeEvent(input$otheryreatmentAdd, {
    ...
    ############
    validate( need(input$injectionnumber>-1, "Error : Missing values or User already exists") )
    ...
    validate(
      need(try(   sqlExecute(connect,query = querytreatpfe) ), "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$subtreatmentQ, {
    ...
    ############
    validate(
      need(input$injectionnumber>-1, "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$subSampleQ, {
    ...
    validate(
      need(input$diamlesionMax>=-1, "Error : Missing values or User already exists")
    )
    validate(
      need(input$diamlesionMin>=-1, "Error : Missing values or User already exists")
    )
    validate(
      need(input$highlesion>=-1, "Error : Missing values or User already exists")
    )
    #############################################################""
    ###########################################################""
    ############################################################""
    ...
    validate(
      need(try(     sqlExecute(connect,query = querysampleinpfe)), "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$submitIDpfe, {
    ...
    validate(
      need(try(       sqlExecute(connect,query = queryinterrpfe)), "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$submitDiag, {
    ...
    validate(
      need(try(      sqlExecute(connect,query = querydiagpfe)), "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$subpfelab , {
    ...
    validate(
      need(try(       sqlExecute(connect, querylabpfe)), "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$subusernew, {
    ...
    validate(
      need(try(sqlExecute(connect,query = queryuseraddpfe)  ), "Error : Missing values or User already exists")
    )
  ...
  observeEvent(input$okCheck,{
    ...
    validate(
      need(input$Lesion_NumberUP>= -1, "Error : Missing values or User already exists")
    )
  ...
  output$testtreatFFFFFF=renderUI({
    box(width = 12,
        ...
        column("",numericInput("datetreatendUP","Treatment Duration (in weeks)",value = UPdatavalueTreat()$DURATIONN), width = 4),
  ...
  output$testmvtFFFFFF=renderUI({
    box(width = 12,
        ...
        column("",numericInput("dateleavevisitUP","Duration (In wek)",value = UPdatavalueMvt()$TODATE), width = 4)
